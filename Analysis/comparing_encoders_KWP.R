...
BGRU0 = rbind(BGRU10_0i, BGRU20_0i, BGRU30_0i) %>% filter(!str_detect(out, "\\d"))
rm(BGRU10_0i, BGRU20_0i, BGRU30_0i)
rm(BGRU10_0, BGRU20_0, BGRU30_0)
write_csv(BGRU0, "BGRU0")
...
CONV0 = rbind(CONV10_0i, CONV20_0i, CONV30_0i)  %>% filter(!str_detect(out, "\\d"))
rm(CONV10_0i, CONV20_0i, CONV30_0i)
rm(CONV10_0, CONV20_0, CONV30_0)
CONV0 %>% filter(!str_detect(out, "\\d")) %>% write_csv("CONV0")
...
INFS0 = rbind(INFS10_0i, INFS20_0i, INFS30_0i) %>% filter(!str_detect(out, "\\d"))
rm(INFS10_0i, INFS20_0i, INFS30_0i)
rm(INFS10_0, INFS20_0, INFS30_0)
write_csv(INFS0, "INFS0")
...
INNR0 = rbind(INNR10_0i, INNR20_0i, INNR30_0i) %>% filter(!str_detect(out, "\\d"))
rm(INNR10_0i, INNR20_0i, INNR30_0i)
rm(INNR10_0, INNR20_0, INNR30_0)
write_csv(INNR0, "INNR0")
...
BGRU2 = rbind(BGRU10_2i, BGRU20_2i, BGRU30_2i) %>% filter(!str_detect(out, "\\d"))
rm(BGRU10_2i, BGRU20_2i, BGRU30_2i)
rm(BGRU10_2, BGRU20_2, BGRU30_2)
write_csv(BGRU2, "BGRU2")
...
CONV2 = rbind(CONV10_2i, CONV20_2i, CONV30_2i) %>% filter(!str_detect(out, "\\d"))
rm(CONV10_2i, CONV20_2i, CONV30_2i)
rm(CONV10_2, CONV20_2, CONV30_2)
write_csv(CONV2, "CONV2")
...
INFS2 = rbind(INFS10_2i, INFS20_2i, INFS30_2i) %>% filter(!str_detect(out, "\\d"))
rm(INFS10_2i, INFS20_2i, INFS30_2i)
rm(INFS10_2, INFS20_2, INFS30_2)
write_csv(INFS2, "INFS2")
...
INNR2 = rbind(INNR10_2i, INNR20_2i, INNR30_2i) %>% filter(!str_detect(out, "\\d"))
rm(INNR10_2i, INNR20_2i, INNR30_2i)
rm(INNR10_2, INNR20_2, INNR30_2)
write_csv(INNR2, "INNR2")
