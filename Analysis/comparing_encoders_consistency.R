...
BGRU10_0 = read_csv("ttr10tests_BGRU.csv")
BGRU20_0 = read_csv("ttr20tests_BGRU.csv")
BGRU30_0 = read_csv("ttr30tests_BGRU.csv")
CONV10_0 = read_csv("ttr10tests_ConvNet.csv")
CONV20_0 = read_csv("ttr20tests_ConvNet.csv")
CONV30_0 = read_csv("ttr30tests_ConvNet.csv")
INFS10_0 = read_csv("ttr10tests_InferSent.csv")
INFS20_0 = read_csv("ttr20tests_InferSent.csv")
INFS30_0 = read_csv("ttr30tests_InferSent.csv")
INNR10_0 = read_csv("ttr10tests_InnerAttentionMILA.csv")
INNR20_0 = read_csv("ttr20tests_InnerAttentionMILA.csv")
INNR30_0 = read_csv("ttr30tests_InnerAttentionMILA.csv")

setwd("~/U3/compositionality-code/Code/Variability/results/paired_outputs/step2")
BGRU10_2 = read_csv("ttr10tests_BGRU.csv")
BGRU20_2 = read_csv("ttr20tests_BGRU.csv")
BGRU30_2 = read_csv("ttr30tests_BGRU.csv")
CONV10_2 = read_csv("ttr10tests_ConvNet.csv")
CONV20_2 = read_csv("ttr20tests_ConvNet.csv")
CONV30_2 = read_csv("ttr30tests_ConvNet.csv")
INFS10_2 = read_csv("ttr10tests_InferSent.csv")
INFS20_2 = read_csv("ttr20tests_InferSent.csv")
INFS30_2 = read_csv("ttr30tests_InferSent.csv")
INNR10_2 = read_csv("ttr10tests_InnerAttentionMILA.csv")
INNR20_2 = read_csv("ttr20tests_InnerAttentionMILA.csv")
INNR30_2 = read_csv("ttr30tests_InnerAttentionMILA.csv")
...
BGRU10_0i = BGRU10_0 %>% cleanpairs() %>% mutate(condition = "0", series = "10", encoder = "BGRU")
BGRU20_0i = BGRU20_0 %>% cleanpairs() %>% mutate(condition = "0", series = "20", encoder = "BGRU")
BGRU30_0i = BGRU30_0 %>% cleanpairs() %>% mutate(condition = "0", series = "30", encoder = "BGRU")
BGRU0 = rbind(BGRU10_0i, BGRU20_0i, BGRU30_0i)
rm(BGRU10_0i, BGRU20_0i, BGRU30_0i)
rm(BGRU10_0, BGRU20_0, BGRU30_0)
CONV10_0i = CONV10_0 %>% cleanpairs() %>% mutate(condition = "0", series = "10", encoder = "CONV")
CONV20_0i = CONV20_0 %>% cleanpairs() %>% mutate(condition = "0", series = "20", encoder = "CONV")
CONV30_0i = CONV30_0 %>% cleanpairs() %>% mutate(condition = "0", series = "30", encoder = "CONV")
CONV0 = rbind(CONV10_0i, CONV20_0i, CONV30_0i)
rm(CONV10_0i, CONV20_0i, CONV30_0i)
rm(CONV10_0, CONV20_0, CONV30_0)
INFS10_0i = INFS10_0 %>% cleanpairs() %>% mutate(condition = "0", series = "10", encoder = "INFS")
INFS20_0i = INFS20_0 %>% cleanpairs() %>% mutate(condition = "0", series = "20", encoder = "INFS")
INFS30_0i = INFS30_0 %>% cleanpairs() %>% mutate(condition = "0", series = "30", encoder = "INFS")
INFS0 = rbind(INFS10_0i, INFS20_0i, INFS30_0i)
rm(INFS10_0i, INFS20_0i, INFS30_0i)
rm(INFS10_0, INFS20_0, INFS30_0)
INNR10_0i = INNR10_0 %>% cleanpairs() %>% mutate(condition = "0", series = "10", encoder = "INNR")
INNR20_0i = INNR20_0 %>% cleanpairs() %>% mutate(condition = "0", series = "20", encoder = "INNR")
INNR30_0i = INNR30_0 %>% cleanpairs() %>% mutate(condition = "0", series = "30", encoder = "INNR")
INNR0 = rbind(INNR10_0i, INNR20_0i, INNR30_0i)
rm(INNR10_0i, INNR20_0i, INNR30_0i)
rm(INNR10_0, INNR20_0, INNR30_0)

BGRU10_2i = BGRU10_2 %>% cleanpairs() %>% mutate(condition = "2", series = "10", encoder = "BGRU")
BGRU20_2i = BGRU20_2 %>% cleanpairs() %>% mutate(condition = "2", series = "20", encoder = "BGRU")
BGRU30_2i = BGRU30_2 %>% cleanpairs() %>% mutate(condition = "2", series = "30", encoder = "BGRU")
BGRU2 = rbind(BGRU10_2i, BGRU20_2i, BGRU30_2i)
rm(BGRU10_2i, BGRU20_2i, BGRU30_2i)
rm(BGRU10_2, BGRU20_2, BGRU30_2)
CONV10_2i = CONV10_2 %>% cleanpairs() %>% mutate(condition = "2", series = "10", encoder = "CONV")
CONV20_2i = CONV20_2 %>% cleanpairs() %>% mutate(condition = "2", series = "20", encoder = "CONV")
CONV30_2i = CONV30_2 %>% cleanpairs() %>% mutate(condition = "2", series = "30", encoder = "CONV")
CONV2 = rbind(CONV10_2i, CONV20_2i, CONV30_2i)
rm(CONV10_2i, CONV20_2i, CONV30_2i)
rm(CONV10_2, CONV20_2, CONV30_2)
INFS10_2i = INFS10_2 %>% cleanpairs() %>% mutate(condition = "2", series = "10", encoder = "INFS")
INFS20_2i = INFS20_2 %>% cleanpairs() %>% mutate(condition = "2", series = "20", encoder = "INFS")
INFS30_2i = INFS30_2 %>% cleanpairs() %>% mutate(condition = "2", series = "30", encoder = "INFS")
INFS2 = rbind(INFS10_2i, INFS20_2i, INFS30_2i)
rm(INFS10_2i, INFS20_2i, INFS30_2i)
rm(INFS10_2, INFS20_2, INFS30_2)
INNR10_2i = INNR10_2 %>% cleanpairs() %>% mutate(condition = "2", series = "10", encoder = "INNR")
INNR20_2i = INNR20_2 %>% cleanpairs() %>% mutate(condition = "2", series = "20", encoder = "INNR")
INNR30_2i = INNR30_2 %>% cleanpairs() %>% mutate(condition = "2", series = "30", encoder = "INNR")
INNR2 = rbind(INNR10_2i, INNR20_2i, INNR30_2i)
rm(INNR10_2i, INNR20_2i, INNR30_2i)
rm(INNR10_2, INNR20_2, INNR30_2)

setwd("~/U3/compositionality-code/Code/Variability/results/paired_outputs/step2")
ttrs_2 = rbind(BGRU2, CONV2, INFS2, INNR2)
write_csv(ttrs_2, "ttrs2")

setwd("~/U3/compositionality-code/Code/Variability/results/paired_outputs/step0")
ttrs_0 = rbind(BGRU0, CONV0, INFS0, INNR0)
write_csv(ttrs_0, "ttrs0")
